...
-- $Id: //Infrastructure/GitHub/Database/asbo/osse/sys_grants.sql#9 $
--
...
--GRANT ADVISOR TO DBAMGR;
--GRANT ADMINISTER SQL MANAGEMENT OBJECT to DBAMGR;
--GRANT EXECUTE ON DBMS_SQLTUNE TO DBAMGR;
